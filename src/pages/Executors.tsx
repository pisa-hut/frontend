  ...
  const columns = [
    {
      ...
      key: "id",
      width: 60,
      sorter: (a: ExecutorResponse, b: ExecutorResponse) => a.id - b.id,
      ...getColumnSearchProps<ExecutorResponse>("id"),
    },
    {
      title: "Hostname",
      dataIndex: "hostname",
      key: "hostname",
      ellipsis: true,
      ...getColumnSearchProps<ExecutorResponse>("hostname"),
    },
    {
      title: "Job ID",
    ...
    { title: "Array", dataIndex: "slurm_array_id", key: "slurm_array_id", width: 80 },
    {
      ...
      key: "slurm_node_list",
      ellipsis: true,
      ...getColumnSearchProps<ExecutorResponse>("slurm_node_list"),
    },
  ];
